            ...
            <form id="snqeForm">
                <?php if (!$isLogsView): ?>
                    <div class="btn-group">
                        ...
                        <a href="https://dwemerdynamics.com/chim/index.html" target="_blank" style="color:#60a5fa; font-size:0.9em; margin-bottom: 20px; display:inline-block;position:absolute;right:5px;top:-50px">Documentation</a>
                    </div>
