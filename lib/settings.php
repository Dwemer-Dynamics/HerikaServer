...
if (!function_exists('chimGlobalLlmConnectorAvailabilityMap')) {
    ...
    function chimGlobalLlmConnectorAvailabilityMap(): array
    {
        return [
            ...
            'CORE_CONNECTOR_QUEST_CREATION' => 'CORE_CONNECTOR_QUEST_CREATION_ENABLED',
            'CORE_CONNECTOR_QUEST_ENGINE' => 'CORE_CONNECTOR_QUEST_ENGINE_ENABLED',
...
if (!function_exists('chimGetManagedGeneralSettingIds')) {
    function chimGetManagedGeneralSettingIds(): array
    {
        return [
            ...
            'CORE_CONNECTOR_QUEST_CREATION_ENABLED',
            'CORE_CONNECTOR_QUEST_ENGINE',
            'CORE_CONNECTOR_QUEST_ENGINE_ENABLED',
            'CORE_CONNECTOR_BGL',
            'RELLLM_CONNECTOR',
            'PLAYER_RESPEECH',
